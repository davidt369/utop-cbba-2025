...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="w-full overflow-x-auto">
      <div
        className="flex flex-wrap gap-2 sm:gap-4 items-center justify-between px-2 min-w-[340px]"
      >
        <div className="flex-1 text-sm text-muted-foreground min-w-[150px]">
          {table.getFilteredSelectedRowModel().rows.length} de{" "}
          {table.getFilteredRowModel().rows.length} fila(s) seleccionada(s).
        </div>
        <div className="flex flex-wrap items-center gap-2 sm:gap-6 lg:gap-8 justify-end">
