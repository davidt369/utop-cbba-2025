...
import { useMisAusencias, type MiAusencia } from '@/hooks/mi-perfil.queries';
...
export default function MisAusenciasPage() {
    ...
    const getEstadoBadge = (ausencia: MiAusencia) => {
    ...
    const getTipoColor = (tipo: "Permiso" | "Baja Médica" | "Vacaciones") => {
        switch (tipo) {
            case 'Baja Médica':
                return 'text-red-600';
            case 'Vacaciones':
